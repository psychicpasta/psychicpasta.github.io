...
{
	m_pShaderManager->setVec3Value("lightSources[0].position", 15.0f, 15.0f, 0.6f);
	...
	m_pShaderManager->setVec3Value("lightSources[2].position", -15.0f, 15.0f, 6.0f);
...
void SceneManager::LoadSceneTextures()
{
	...
	bReturn = CreateGLTexture(
		"circular-brushed-gold-texture.jpg",
		"candle");
...
void SceneManager::RenderScene()
{
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-1.0f, 3.1f, 0.0f);
	...
	//..Book 1
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(6.0f, 1.0f, 8.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(4.5f, 1.5f, 3.0f);
	...
	//..Candle
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(1.0f, 2.4f, 1.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(4.9f, 2.0f, 3.5f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(4.9f, 4.4f, 3.5f);
	...
	//..Weight handle
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.75f, 6.0f, 1.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-5.0f, 1.5f, 2.3f);
	...
	//..Weight end 1
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(3.0f, 3.0f, 2.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-5.0f, 1.5f, 2.4f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-10.0f, 1.5f, 7.1f);
